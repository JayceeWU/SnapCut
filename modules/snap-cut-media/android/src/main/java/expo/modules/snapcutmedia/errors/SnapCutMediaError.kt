...
internal enum class SnapCutMediaError(
  ...
  FLAC_ENCODER_INIT_FAILED("FLAC_ENCODER_INIT_FAILED", "The FLAC encoder could not start."),
  FLAC_ENCODER_FAILED("FLAC_ENCODER_FAILED", "FLAC encoding failed."),
  FLAC_VERIFICATION_FAILED("FLAC_VERIFICATION_FAILED", "The FLAC output could not be verified."),
